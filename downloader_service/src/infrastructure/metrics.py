...
images_downloaded = Counter(
    'downloader_images_downloaded_total',
    'Number of images successfully downloaded'
)
download_errors = Counter(
    'downloader_download_errors_total',
    'Number of download errors encountered'
)
download_latency = Histogram(
    'downloader_download_latency_seconds',
    'Time taken to download images'
)
